...
#' @export
turnToPCAgg=function(resPca,axes=list(c(1,2)),representation="DistanceBiplot",expandBiplot=NULL)
{
  print("in2")
  ...
  for(i in 1:length(axes)) 
  {
    ...
    if(dataType=="productMeans")
    {
      ...
      {
        resell=calculateEllipses(resPca$IndSup,resPca$EigenVectors,axes=axes_tmp,confInt=0.9,ellipseType="barycentric",productName="product",subjectName="subject",ellipseCalculation="Chi",bootstrap=FALSE,nSamples=100)
